        ...
        <div class="mt-2">
            <form method="get" action="{{route('phan-loai', $category->name)}}" class="bg-white my-2 block border-1 p-1 px-2 shadow-[1px_0_5px_1px_rgba(6,6,6,0.3)]">
                <div class="lg:flex inline-block text-center">
                    <div class="xl:flex flex-auto inline-block">
                    ...
                    <div class="flex-auto lg:flex inline-block text-nowrap">
                        ...
                        <input type="text" name="title" id="title" placeholder="Máy lọc nước" value="{{request('title')}}"
                               class="min-w-[100px] max-w-[150px] xl:max-w-[250px] inline-block bg-gray-100 px-2 outline-none focus:border-blue-500 focus:ring focus:ring-blue-200 focus:ring-opacity-50"/>
                    </div>
                    ...
                    <div class="flex-auto ml-2 inline-block">
                        <input type="submit" class="lg:h-[48px] h-[42px]  bg-cyan-500 px-8 text-white border-1 border-cyan-700 outline-none hover:bg-cyan-700 focus:ring" value="Lọc"/>
                    </div>
                </div>
            </form>
        </div>
